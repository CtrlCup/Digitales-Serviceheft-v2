...
return [
    ...
    // Service-Erfassung
    ,'service_create_title' => 'Service/Eintrag hinzufügen'
    ,'service_type' => 'Art des Eintrags'
    ,'service_date' => 'Datum'
    ,'service_items' => 'Ausgaben/Positionen'
    ,'item_label' => 'Bezeichnung'
    ,'item_amount' => 'Betrag (€)'
    ,'item_note' => 'Notiz'
    ,'item_label_ph' => 'z.B. Ölfilter, Arbeitszeit'
    ,'item_note_ph' => 'Optionale Notiz'
    ,'next_due_km' => 'Nächster fällig bei (km)'
    ,'next_due_date' => 'Nächster fällig am (Datum)'
    ,'service_saved_success' => 'Service wurde gespeichert.'
    ,'service_save_failed' => 'Service konnte nicht gespeichert werden.'
    ,'form_invalid' => 'Bitte fülle alle Pflichtfelder korrekt aus.'
    ,'service_type_repair' => 'Reparatur'
    ,'service_type_oil_change' => 'Ölwechsel'
    ,'service_type_service' => 'Service/Wartung'
    ,'service_type_tuev' => 'TÜV/HU'
    ,'service_type_tires' => 'Reifen'
    ,'service_type_brakes' => 'Bremsen'
    ,'service_type_battery' => 'Batterie'
    ,'account_intervals_title' => 'Wartungsintervalle'
    ,'account_intervals_desc' => 'Standard-Intervalle für Ölwechsel und Service. Diese Werte werden zur Berechnung des nächsten Termins/Kilometerstandes verwendet.'
    ,'oil_interval_km' => 'Ölwechsel-Intervall (km)'
    ,'oil_interval_years' => 'Ölwechsel-Intervall (Jahre)'
    ,'service_interval_km' => 'Service-Intervall (km)'
    ,'service_interval_years' => 'Service-Intervall (Jahre)'
    ,'intervals_saved_success' => 'Intervalle wurden gespeichert.'
    ,'recent_service_entries' => 'Letzte Service-Einträge'
    ,'no_service_entries_yet' => 'Noch keine Einträge vorhanden.'
    ,'edit_service' => 'Service bearbeiten'
    ,'delete_service' => 'Service löschen'
    ,'confirm_delete_service' => 'Möchtest du diesen Service wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.'
    ,'service_deleted_success' => 'Service wurde gelöscht.'
    ,'service_updated_success' => 'Service wurde aktualisiert.'
    ,'service_edit_title' => 'Service bearbeiten'
